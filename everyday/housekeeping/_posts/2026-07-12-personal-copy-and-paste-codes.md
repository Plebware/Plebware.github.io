...
The date in this example is generated by Jekyll when the site is built, so the displayed copy-and-paste example automatically uses the current build date.
