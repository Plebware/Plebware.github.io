...
# Mode-Specific Tool for Graphics
...
* **State-Driven Application Execution:**
  ...
  * **`COGNITIVE` State:** Renders a GTK checklist dialogue using `zenity`, allowing the user to select specific tools to launch for their current task.
